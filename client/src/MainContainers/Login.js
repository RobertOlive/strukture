...
class Login extends Component {
    ...
    newUserCreate = event => {
        ...
        const newUsername = document.getElementById("InputUser2").value,
                newPass = document.getElementById("InputPassword2").value,
                newPassConf = document.getElementById("InputPassword3").value,
                newBudget = document.getElementById("newBudget").value;
    ...
    userLogin = event => {
        ...
        const currentUsername = document.getElementById("InputUser1").value,
                currentPassword = document.getElementById("InputPassword1").value;
